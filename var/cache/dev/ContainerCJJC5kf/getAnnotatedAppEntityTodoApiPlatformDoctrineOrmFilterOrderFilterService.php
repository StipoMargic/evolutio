 ...
 */
class getAnnotatedAppEntityTodoApiPlatformDoctrineOrmFilterOrderFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'annotated_app_entity_todo_api_platform_doctrine_orm_filter_order_filter' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotated_app_entity_todo_api_platform_doctrine_orm_filter_order_filter'] = new \ApiPlatform\Doctrine\Orm\Filter\OrderFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), 'order', ($container->privates['logger'] ?? $container->getLoggerService()), ['createdAt' => 'DESC'], ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()), NULL);
    }
}
